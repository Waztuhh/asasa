...
run: async (client, message, args, embed, prefix) => { 
    ...
    {
    message.react(red)
    message.lineReply(`\`${prefix}isim <@Yousef/ID> <Isim> <Yaş>\``).then(x=>x.delete({timeout:5000})) 
    return }
...
.setFooter(`Üyesinin önceki isimlerine <!isimler @Yousef/ID> komutuyla bakarak kayıt işlemini gerçekleştirmeniz önerilir.`))
