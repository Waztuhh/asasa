...
const canvas = Canvas.createCanvas(670, 630);
    ...
    const background = await Canvas.loadImage('https://media.discordapp.net/attachments/792719188770160660/916693254957838386/Yousef.png?width=503&height=473');  
 ...
 ctx.save();
  ...
  const attachment = new MessageAttachment(canvas.toBuffer(), 'Yousef.png');
