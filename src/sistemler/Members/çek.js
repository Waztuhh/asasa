...
moment.locale("tr");
const Yousefayar = require('../../ayarlar/sunucuayarlar.json')
...
run: async (client, message, args, embed, prefix) => {
  ...
  if (message.member.permissions.has("ADMINISTRATOR")) {
    ...
    message.guild.channels.cache.get(Yousefayar.voiceLogChannel).wsend(log);
} else {
...
let msg = await message.channel.send((member.toString()), { components : [ row ], embed: Yousef})
