...
const { partner, online, duyuru, channel } = require("../../ayarlar/emojiler.json")
module.exports = {
  conf: {
    aliases: ["ekip-all"],
    name: "ekip-all",
...
let foto;
let attachments = new MessageAttachment(buffer, "Yousef.png");
...
let Yousef = new MessageEmbed() 
             ...
             .setImage("attachment://Yousef.png") 
            .addField(`Shew 1983`,`
...
message.channel.send({ embed: Yousef, files: [attachments] })
