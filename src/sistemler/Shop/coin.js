...
const { altin2 } = require("../../ayarlar/emojiler.json");
...
let dolarData = await dolar.findOne({ guildID: message.guild.id, userID: message.author.id });  
  ...
  const applyText = (canvas, text) => {
    ...
    const background = await Canvas.loadImage('https://media.discordapp.net/attachments/899273632696631365/910532483282522162/Yousef_card_3.png');
