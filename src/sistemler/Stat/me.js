...
const taggeds = require("../../mongoo/taggeds");
...
const {  rewards, miniicon, mesaj2, staff, galp ,Muhabbet ,star , fill, empty, fillStart, emptyEnd, fillEnd, red } = require("../../ayarlar/emojiler.json");
...
\`\`\`fix
${inviterData ? `${total} davet`: "Veri bulunmuyor."} 
\`\`\`
`, inline: true },
