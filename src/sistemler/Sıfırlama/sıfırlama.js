...
const cezapuans = require("../../mongoo/cezapuan");
const ceza = require("../../mongoo/ceza")
const name = require("../../mongoo/names");
const penals = require("../../mongoo/penals");
require("moment-duration-format");
const conf = require("../../ayarlar/sunucuayarlar.json");
const { kirmiziok, green, red ,star } = require("../../ayarlar/emojiler.json");
