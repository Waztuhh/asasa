...
const Log = require("../ayarlar/sunucuayarlar.json")
const roller = require("../mongoo/rolveridb")
...
.setColor("RANDOM")
.setDescription(`Kişinin eklenen ve alınan tüm rollerine bakmak için \`!rollog @Yousef\` komutunu kullanın \n
**Rol Eklenen kişi**\n ${hedef} - **${hedef.id}** `)
...
.setAuthor(hedef.tag, hedef.displayAvatarURL({ dynamic: true }))
.setColor("RANDOM")
.setDescription(`Kişinin alınan ve eklenen tüm rollerine bakmak için \`!rollog @Yousef\` komutunu kullanın \n
**Rolü Alınan kişi** \n${hedef} - **${hedef.id}**`)
